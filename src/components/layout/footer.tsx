        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-24">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/founders" className="text-sm hover:text-brand transition-colors">Founders</Link></li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:anurag.founder'soffice@foremostleads.in" className="text-sm hover:text-brand transition-colors block break-words">
